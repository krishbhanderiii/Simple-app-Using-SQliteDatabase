...
import com.bawp.contacT.util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addItem(Item item) {
        ...
        values.put(Constants.KEY_QTY_NUMBER, String.valueOf(item.getItemQuantity()));
    ...
    public Item getItem(int id) {
        ...
        if (cursor != null) {
            ...
            item.setItemQuantity(BigInteger.valueOf(Integer.parseInt(String.valueOf(BigInteger.valueOf(cursor.getInt(cursor.getColumnIndex(Constants.KEY_QTY_NUMBER)))))));
